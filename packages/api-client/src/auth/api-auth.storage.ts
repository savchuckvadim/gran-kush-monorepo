...
export class ApiTokensStorage {
    ...
    constructor(type: ApiAuthType) {
        this.ACCESS_TOKEN_KEY = type === ApiAuthType.CRM ? ACCESS_TOKEN_KEY_CRM : ACCESS_TOKEN_KEY_SITE;
        this.REFRESH_TOKEN_KEY = type === ApiAuthType.CRM ? REFRESH_TOKEN_KEY_CRM : REFRESH_TOKEN_KEY_SITE;
    }
