...
import { QrCodeWithPayloadDto } from "@modules/portal/crm/qr-codes/api/dto/qr-code.dto";
import { mapQrCodeToPayloadDto } from "@modules/portal/crm/qr-codes/api/mappers";
