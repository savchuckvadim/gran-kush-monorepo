                    ...
                    <Container className="mx-auto my-10 max-w-[500px] rounded-lg bg-white p-8 shadow-lg">
                        <Section className="text-center">
                            ...
                            <Text
                                ...
                                style={{ fontFamily: "Geist, Arial" }}
                            >
                                Привет, {name} {surname ?? ""}! Мы рады сообщить, что ограничение на
                                ваш аккаунт было снято.
                            </Text>
                            ...
                            {violations === 0 && (
                                <Section className="mb-8 rounded-lg border border-yellow-100 bg-yellow-50 p-6">
                                    ...
                                    <Text className="text-gray-700 mt-4">
                                        Это ваше первое нарушение. Если вы продолжите нарушать
                                        правила, следующие нарушения приведут к более строгим мерам,
                                        включая временные и бессрочные блокировки.
                                    </Text>
                                </Section>
                            )}
                            ...
                            {remainingViolations > 0 && (
                                <Section className="mb-8 rounded-lg border border-yellow-100 bg-yellow-50 p-6">
                                    ...
                                    <Text className="text-gray-700 mt-4">
                                        Теперь, когда ваше ограничение снято, у вас осталось{" "}
                                        {remainingViolations}{" "}
                                        {getViolationText(remainingViolations)} до полной блокировки
                                        аккаунта.
                                    </Text>
                                    <Text className="text-gray-700 mt-4">
                                        Пожалуйста, соблюдайте наши правила, чтобы избежать
                                        дальнейших санкций.
                                    </Text>
                                </Section>
                            )}
                            ...
                            {remainingViolations === 0 && (
                                <Section className="mb-8 rounded-lg border border-red-100 bg-red-50 p-6">
                                    ...
                                    <Text className="text-gray-700 mt-4">
                                        Это последний шанс избежать бессрочного блокирования.
                                        Пожалуйста, постарайтесь соблюдать правила платформы.
                                    </Text>
                                </Section>
                            )}
                            ...
                            <Section className="mb-8 rounded-lg border border-green-100 bg-green-50 p-6">
                                ...
                                <Text className="text-gray-700 mt-4">
                                    Ваш аккаунт снова активен! Мы понимаем, что все могут ошибаться,
                                    и рады видеть вас обратно на платформе. Пожалуйста, следите за
                                    соблюдением наших правил в будущем.
                                </Text>
                                <Text className="text-gray-700 mt-4">
                                    Спасибо, что вернулись в сообщество TeaCoder! Мы ценим вашу
                                    активность.
                                </Text>
                            </Section>
                            ...
                            <Text
                                ...
                                style={{ fontFamily: "Geist, Arial" }}
                            >
                                © {new Date().getFullYear()} {smtpFromName}. Все права защищены.
                            </Text>
                        </Section>
                    </Container>
                </Body>
